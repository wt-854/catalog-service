...
@DataJpaTest
// Import the DataConfig - needed for auditing
@Import(DataConfig.class)
// Disable the default behaviour of relying on an embedded test db so that we can use TestContainers
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
// Use "integration" profile to load config
